...
let handler = async (m, { conn, command, text }) => {
  ...
  let pp = await conn.profilePictureUrl(who, 'image').catch((_) => "https://telegra.ph/file/9750464213735ccb3a104.jpg")
...
contextInfo: { externalAdReply :{
                        mediaUrl: 'https://vt.tiktok.com/ZS8BBfPhE/',
                        mediaType: 2,
                        description: 'anu',
                        title: global.titlebot,
                        body: '⚘ ᴄʀᴇᴀᴛᴇ ʙʏ ᴹᴿ᭄ Yura Botz',          previewType: 0,
